...
Via pip `pip install https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.1/bot-3.1-py3-none-any.whl`  
Via uv `uv add https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.1/bot-3.1-py3-none-any.whl`

> **Para referenciar como dependência:**  
Utilizar o link para o arquivo **whl** do release `bot @ https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.1/bot-3.1-py3-none-any.whl`  
Utilizar o caminho para o arquivo **whl** baixado `bot @ file://.../bot-3.1-py3-none-any.whl`
