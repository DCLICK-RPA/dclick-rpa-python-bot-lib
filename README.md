...
`pip install https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.0/bot-3.0-py3-none-any.whl`  
`uv add https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.0/bot-3.0-py3-none-any.whl`

> Referenciar como dependência `bot @ https://github.com/DCLICK-RPA/dclick-rpa-python-bot-lib/releases/download/v3.0/bot-3.0-py3-none-any.whl`
